...
public class ParamServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest peticionHttp, HttpServletResponse respuestaHttp)
        ...
        try (PrintWriter out = respuestaHttp.getWriter()) {
            ...
            //Campos a enviar: nombre e email, obligatorios y con validación HTML5
            out.println("<form name = 'formDatos' action = './formulario' method = 'POST'>");
            out.println("<label>Nombre: </label>");
            out.println("<input id = 'nombre_nombre'  name='nombre' type = 'text' required='required'/>");
            out.println("<label>Email: </label>");
            out.println("<input id = 'nombre_email'  name='email' type = 'email' required='required'/>");
            out.println("<label>Campo: </label>");
            out.println("<input id = 'nombre_campo' name = 'campo'/ type = 'text'>");
