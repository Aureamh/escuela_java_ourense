...
window.addEventListener("load", function () {
    document.getElementById("btn_peticion_ajax").onclick = function () {
        var objAjax = new XMLHttpRequest(); //Objeto que se encarga de hacer 
        ...
        objAjax.open("GET", "./datosjson"); //Petición que hemos construído.
        //Es la función que quiero que nos invoque.
        objAjax.send();
