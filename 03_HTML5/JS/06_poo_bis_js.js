...
var mostrarTodosParam = function(primerParam){
    divBis.innerHTML += "<P>Priemer parámetro:" + primerParam + "</p>"
...
//Precisión double(eso parece)
divBis.innerHTML += "<br/>Valor máx: " + 1.23456789123456789;
